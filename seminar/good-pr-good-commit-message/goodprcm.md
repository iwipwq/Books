...
코드 변경의 "무엇"보다 "왜"가 더 중요한 경우도 있지만, 우리는 이론을 평가하는 것이 아니라 유형적인 코드 변경을 평가하는 것이기 때문에 "무엇" 뒤에 붙이는 경향이 있습니다.

"왜"는 이러한 변화가 어떤 비즈니스 또는 엔지니어링 목표를 달성하는지 알려줍니다. 우리가 개발자로서 돈을 받는 이유이기도 합니다. "왜"는 엔지니어링 목표를 모두 설명할 수 있는 기회일 뿐만 아니라 충족되거나 앞으로 나아갈 수 있는 비즈니스 목표이기도 합니다.
...
여기서 리뷰어가 큰 그림을 보는데 도움이 되는 것들이 없습니다.
마지막 부분에서는 책임을 다른사람에게 넘기기까지 합니다.
...
완전한 문장과 적극적인 소통을 하려는 것을 두려워하지 마세요

### 어떻게 (HOW)

물론 PR diff 가 "어떻게"에 대한 대부분의 설명을 해줄겁니다. 하지만 디자인적인 부분에 주의를 기울여야 합니다. 예를 들어 루프대신 재귀 메소드를 사용한다했을때, 리뷰어에게 재귀의 이점을 설명한다면 리뷰어가 여러분의 의도를 쉽게 파악하여 훨씬 더 나은 리뷰를 제공받을 수 있을겁니다.
